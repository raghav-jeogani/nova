...
export class Run extends Model {
  ...
  declare source_filenames_json: string | null;
  declare source_mimes_json: string | null;
  declare inbox_sender: string | null;
  declare inbox_subject: string | null;
  ...
  declare draft_reply: string | null;
  ...
  Run.init(
    {
      ...
      source_filenames_json: DataTypes.TEXT,
      source_mimes_json: DataTypes.TEXT,
      inbox_sender: DataTypes.TEXT,
      inbox_subject: DataTypes.TEXT,
